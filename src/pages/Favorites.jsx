      ...
      <div>
        <header className="w-full bg-white border-b border-gray-100 flex items-center justify-between px-6 py-4 md:px-12 lg:px-24 relative">
          ...
          <nav className="hidden md:flex items-center justify-center">
            <Link
              to="/"
              className="font-medium text-gray-600 hover:text-gray-950 text-sm md:text-base transition-colors"
            >
              Home
            </Link>
          </nav>
          ...
          <div className="hidden md:flex">
            <Link
              to="/favorites"
              className="flex items-center gap-1.5 font-medium text-red-500 text-sm md:text-base transition-colors"
            >
        ...
        <main className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-10 flex-1">
          ...
          {favoritePlaces.length === 0 ? (
            <div className="py-20 text-center border-2 border-dashed border-gray-200 rounded-2xl max-w-lg mx-auto px-6 mt-8 flex flex-col items-center">
              ...
              <Link
                to="/"
                className="bg-black hover:bg-gray-800 text-white rounded-xl text-sm font-semibold px-6 py-3 transition-colors shadow-sm cursor-pointer"
              >
                Explore Places
              </Link>
            </div>
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex items-center gap-1.5 mt-2.5 text-xs text-gray-800">
                        ...
                        <span className="text-gray-500">
                          ({place.rating?.totalReviews || "120"} reviews)
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-1 mt-3.5 text-xs text-gray-500">
                      ...
                      <span className="truncate">
                        {place.location?.address || "Old GRA, Port Harcourt"}
                      </span>
                    </div>
                  </div>
                </Link>
